    ...
    <div class="col-md-6">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form method="POST" action="{{ route('category.update', $category->id) }}" onsubmit="disableSubmitButton()">
            @csrf
            @method('PATCH')
            @error('name')
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="descriptions" name="descriptions" value="{{ $category->descriptions }}">
            </div>

            <button type="submit" class="btn btn-primary" id="submit-btn">
              <i class="bi bi-pencil-square"></i>
              <span id="button-text">Edit Kategori</span>
