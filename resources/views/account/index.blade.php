                            ...
                            <tbody>
                                @foreach($accounts as $ac)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('account.edit', $ac['id']) }}" class="btn text-bg-dark btn-sm">
                                                <i class="bi bi-pencil-square"></i>
                                                Edit
                                            </a>

                                            <form id="delete-form-{{ $ac->id }}" action="{{ route('account.destroy', $ac->id) }}" method="POST" class="d-inline-block">
                                                @csrf
                                                @method('DELETE')
